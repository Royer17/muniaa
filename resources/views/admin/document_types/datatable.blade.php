        ...
        <div class="box">
          ...
          <div class="box-body">
            <div class="table-responsive">
              <table id="document-type-datatable" class="table table-bordered table-striped">
                <thead>
                  <tr>
...
@include('admin.document_types.crear-editar')
...
@section('scripts')
  ...
  <script type="text/javascript" src="{{ asset('/admin/panel/js/document_type.js') }}"></script>
