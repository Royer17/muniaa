      ...
      <div class="col-lg-12">
        <div class="box">
          <div class="box-header">
            <div class="col-lg-12">
              <button type="button" class="btn btn-success" data-toggle="modal" data-target="" id="schedule__add">
                <i class="fa fa-book-open"></i> Nueva Agenda
              </button>
            </div>
          </div>
          ...
          <div class="box-body">
            <div class="table-responsive">
              <table id="schedule-datatable" class="table table-bordered table-striped">
                <thead>
                  <tr>
...
@include('admin.schedule.crear-editar')
...
@section('scripts')
  ...
  <script type="text/javascript" src="{{ asset('/admin/panel/js/schedule.js') }}"></script>
