        ...
        <div class="box">
          ...
          <div class="box-body">
            <div class="table-responsive">
              <table id="last-documents-datatable" class="table table-bordered table-striped">
                <thead>
                  <tr>
...
@include('admin.last_documents.crear-editar')
...
@section('scripts')
  ...
  <script type="text/javascript" src="{{ asset('/admin/panel/js/last_documents/variables.js') }}"></script>
  <script type="text/javascript" src="{{ asset('/admin/panel/js/last_documents/last_documents.js') }}"></script>
