        ...
        <div class="box">
          ...
          <div class="box-body">
            <div class="table-responsive">
              <table id="accountability-datatable" class="table table-bordered table-striped">
                <thead>
                  <tr>
...
@include('admin.accountability.crear-editar')
...
@section('scripts')
  ...
  <script type="text/javascript" src="{{ asset('/admin/panel/js/accountability.js') }}"></script>
