      ...
      <div class="col-lg-12">
        <div class="box">
          <div class="box-header">
            <div class="col-lg-12">
              <button type="button" class="btn btn-success" data-toggle="modal" data-target="" id="role__add">
                <i class="fa fa-book-open"></i> Nuevo Rol
              </button>
            </div>
          </div>
...
@include('admin.roles.crear-editar')
...
@section('scripts')
  ...
  <script type="text/javascript" src="{{ asset('/admin/panel/js/role.js') }}"></script>
