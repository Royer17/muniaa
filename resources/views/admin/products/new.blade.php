                            ...
                            <form id="product_form" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-7">
                                        ...
                                        <textarea name="description" rows="9" class="form-control" id="product_description"></textarea>
                                        <div class="mensaje-error" id="product-description-error"></div>
                                        </div>
                                        <div class="form-group">
                                        <label for="">Detalles del Producto (Especificaciones)</label>
                                        <textarea name="specifications" rows="9" class="form-control" id="product_specifications"></textarea>
                                        </div>
                                        <div class="form-group">
                                        <label for="">Características del Producto</label>
                                        <textarea name="features" rows="9" class="form-control" id="product_features"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
...
@endsection
@section('scripts')
    <script type="text/javascript" src="/admin/product_create.js"></script>
