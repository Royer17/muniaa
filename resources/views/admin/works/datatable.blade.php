          ...
          <div class="box-header">
            <div class="col-lg-12">
              <button type="button" class="btn btn-success" data-toggle="modal" data-target="" id="btnCrearpublicacion">
                <i class="fa fa-user-plus"></i> Nueva Obra
              </button>
            </div>
          </div>
            ...
            <div class="table-responsive">
              <table id="posts-datatable" class="table table-bordered table-striped">
                <thead>
                  <tr>
                    <th>ID</th>
                    <th style="width: 150px;">Tipo de Obra</th>
                    <th style="width: 350px;">Actividad</th>
...
@include('admin.works.crear-editar')
...
@section('scripts')
  ...
  <script type="text/javascript" src="{{ asset('/admin/panel/js/works/variables.js') }}"></script>
  <script type="text/javascript" src="{{ asset('/admin/panel/js/works/works.js') }}"></script>
