          ...
          <div>
            ...
            <div class="flex justify-center">
               <!-- <iframe class="w-full h-128 md:w-2/3 md:h-96 border-2 border-gray-300 rounded-lg shadow-lg"
                ...
                <iframe src="https://www.transparencia.gob.pe/enlaces/pte_transparencia_enlaces.aspx?id_entidad=11734&id_tema=1&ver=D#.YT7HAZ0zaHv" width="100%" height="1100" title="Portal de Transparencia" style="padding-top:1px;"></iframe>
            </div>
