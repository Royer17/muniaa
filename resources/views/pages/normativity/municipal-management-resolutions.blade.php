    ...
    <div class="banner-inner">
        <div class="container-lg">
            <div class="inner-container clearfix">
                <h1>Resoluciones de Gerencia Municipal</h1>
                <div class="page-nav">
                    <ul class="bread-crumb clearfix">
                        <li><a href="{{ route('pages.home') }}">Inicio</a></li>
                        <li><a href="">Normatividad</a></li>
                        <li class="active">Resoluciones de Gerencia Municipal</li>
                    </ul>
                </div>
            </div>
        </div>
...
<section class="default-section">
    <div class="container-lg">
        ...
        <input type="hidden" name="" value="Resolución de Gerencia Municipal" id="tipodocu">
        <div class="row ">
        <!-- contenido -->
