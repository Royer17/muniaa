          ...
          <div class="box-header">
            <div class="col-lg-12">
              <button type="button" class="btn btn-success" data-toggle="modal" data-target="" id="btnCrearpublicacion">
                <i class="fa fa-user-plus"></i> Crear Nueva Noticia
              </button>
            </div>
          </div>
              ...
              <table id="posts-datatable" class="table table-bordered table-striped">
                <thead>
                  <tr>
                    ...
                    <th style="width: 350px;">Resumen</th>
...
@section('scripts')
  ...
  <script type="text/javascript" src="{{ asset('/admin/panel/js/slider/charge_slider.js') }}"></script>
  <script type="text/javascript" src="{{ asset('/admin/panel/js/posts/post-dropzone.js') }}"></script>
  <script type="text/javascript" src="{{ asset('/admin/panel/js/posts/variables.js') }}"></script>
