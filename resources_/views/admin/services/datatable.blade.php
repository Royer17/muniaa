      ...
      <div class="col-lg-12">
        <div class="box">
          <div class="box-header">
            <div class="col-lg-12">
              <button type="button" class="btn btn-success" data-toggle="modal" data-target="" id="service-add">
                <i class="fa fa-hand-point-up"></i> Nuevo Servicio
              </button>
            </div>
          </div>
          ...
          <div class="box-body">
            <div class="table-responsive">
              <table id="services-datatable" class="table table-bordered table-striped">
                <thead>
                  <tr>
...
@include('admin.services.crear-editar')
...
@section('scripts')
  ...
  <script type="text/javascript" src="{{ asset('/admin/panel/js/services/variables.js') }}"></script>
  <script type="text/javascript" src="{{ asset('/admin/panel/js/services/services.js') }}"></script>
