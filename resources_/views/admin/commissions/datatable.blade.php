        ...
        <div class="box">
          ...
          <div class="box-body">
            <div class="table-responsive">
              <table id="commissions-datatable" class="table table-bordered table-striped">
                <thead>
                  <tr>
...
@include('admin.commissions.crear-editar')
...
@section('scripts')
  ...
  <script type="text/javascript" src="{{ asset('/admin/panel/js/commissions.js') }}"></script>
