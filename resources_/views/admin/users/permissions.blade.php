      ...
      <div class="col-lg-12">
        <div class="box">
          ...
          <div class="box-body">
              ...
              <form id="permission-form">
                @foreach($permission_list as $key => $permission_one)
                  <div class="form-check">
                    ...
                    <input data-xd="{{ $permission_one->user }}" data-index="{{ $permission_one->id }}" id="flexCheckChecked{{ $key }}" class="form-check-input" name="permission_value[]" type="checkbox" {{ $permission_one->user == "[]" ? '' : 'checked' }}>
            ...
            <div class="col-md-12">
                <button class="pull-right btn btn-success btn-ms solsoSave margin-left" data-message-title="Create notification" data-message-error="Validation error messages" data-message-success="Data was saved" id="user-update">
...
@section('scripts')
  ...
  <script type="text/javascript">
    document.querySelector('#user-update').addEventListener('click', (e) => {
      e.preventDefault();
      lockWindow();
      ...
      const route = "/admin/user/"+document.querySelector('#user-id').value+`/permissions`;
