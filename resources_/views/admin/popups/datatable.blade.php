          ...
          <div class="box-header">
            <div class="col-lg-12">
              <button type="button" class="btn btn-success" data-toggle="modal" data-target="" id="btnCrearpublicacion">
                <i class="fa fa-window-restore"></i> Nueva Popup
              </button>
            </div>
          </div>
              ...
              <table id="posts-datatable" class="table table-bordered table-striped">
                <thead>
                  <tr>
                    ...
                    <th style="width: 350px;">Visible</th>
...
@include('admin.popups.crear-editar')
...
@section('scripts')
  ...
  <script type="text/javascript" src="{{ asset('/admin/panel/js/popups/variables.js') }}"></script>
  <script type="text/javascript" src="{{ asset('/admin/panel/js/popups/popups.js') }}"></script>
